    ...
    const recentActivity = [
      {
        id: 1,
        type: "RFQ",
        message: "New RFQ from ABC Corp for Industrial Machinery",
        time: "2 hours ago",
      },
      {
        id: 2,
        type: "Lead",
        message: "Lead follow-up reminder for Electronics products",
        time: "5 hours ago",
      },
      {
        id: 3,
        type: "Message",
        message: "New message from buyer regarding pricing",
        time: "1 day ago",
      },
    ];
    ...
    return (
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your purchases and supplier relationships
          </p>
        </div>

            ...
            {viewMode === 'grid' ? (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {filteredProducts.map((product) => (
                  <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-all hover:border-primary cursor-pointer group">
              ...
              <div className="space-y-4">
                {filteredProducts.map((product) => (
                  <Card key={product.id} className="p-4 hover:border-primary transition-colors cursor-pointer group flex gap-4">

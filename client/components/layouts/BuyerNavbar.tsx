    ...
    <header className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6 ml-8">
                ...
                <div className="p-4 space-y-3">
                  <div className="p-3 bg-green-50 rounded border border-green-200 text-sm">
                    ...
                    <p className="text-green-800 text-xs">
                      3 suppliers replied to your RFQ
                    </p>
                  </div>
        ...
        >
          ...
          >
            <div className="w-9 h-9 bg-linear-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center text-white text-sm font-semibold">

              ...
              <div className="max-h-96 overflow-y-auto">
                <div className="p-4 space-y-3">
                  <div className="p-3 bg-green-50 rounded border border-green-200 text-sm">
                    <p className="font-medium text-green-900">New RFQ Request</p>
                    <p className="text-green-800 text-xs">2 min ago - Manufacturing components</p>
                  </div>
                  <div className="p-3 bg-blue-50 rounded border border-blue-200 text-sm">
                    <p className="font-medium text-blue-900">New Lead Message</p>
                    <p className="text-blue-800 text-xs">5 min ago - Bulk order inquiry</p>
                  </div>
                </div>
              </div>
            </div>
